...
async function updateNewPassword(resetToken, hashedPassword) {
    return await User.findOneAndUpdate({ _id: resetToken._id }, { password: hashedPassword, confirmPassword: hashedPassword, resetToken: null, resetTokenExpiresAt: null })
}
...
export { getUserByName, genPassword, getUserByEmail, genToken, storeResetToken, getUserByResetToken, updateNewPassword, getUserById }